...
const SignUp = (props) => {
    ...
    return (
        ...
        <div className=' fullPage '>
            ...
            <div className="image max-w-full  ">
            ...
            <div className='signuoForm w-full max-w-lg m-auto  '>
                ...
                <form id='formup' className="max-w-md  bg-gray-100 border border-slate-300 p-[2rem] text-black rounded-lg" title='SIGNUP FORM' onSubmit={createAccount} >
